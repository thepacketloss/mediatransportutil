...
func NewWebRTCConfig(rtcConf *RTCConfig, development bool) (*WebRTCConfig, error) {
	...
	} else if !rtcConf.NodeIP.IsEmpty() && (rtcConf.UseExternalIP || !rtcConf.NodeIPAutoGenerated) {
	...
	for _, ip := range localIPs {
		...
		go func(localIP string) {
			...
			for _, port := range udpPorts {
				addr, err := getExternalIP(ctx, stunServers, &net.UDPAddr{IP: net.ParseIP(localIP), Port: port}, !rtcConf.SkipExternalIPValidation, "udp")
				if err != nil {
